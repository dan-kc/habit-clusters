...
describe('Signup route', () => {
  ...
  it('requires email', () => {
    ...
    cy.get('input[type="checkbox"]')
      ...
      .click()
      .get('input[name="password"]')
      .type(happyStub.password, { force: true })
      .get('input[name="confirm_password"]')
      .click()
      .get('input[name="confirm_password"]')
      .type(happyStub.password, {
        force: true,
      })
  ...
  it('requires password', () => {
    ...
    cy.get('input[name="email"]')
      ...
      //Assert
      .get('input[name="password"]:invalid')
      .should('have.length', 1);
  });
  ...
  it('requires valid password', () => {
    ...
    cy.get('input[name="email"]')
      ...
      // Assert
      .get('p')
      .should('contain.text', 'Password must be 6 or more characters');
  });
  ...
  it('requires confirm password', () => {
    ...
    cy.get('input[name="email"]')
      ...
      //Assert
      .get('input[name="confirm_password"]:invalid')
      .should('have.length', 1);
  });
  ...
  it('requires checkbox', () => {
    ...
    cy.get('input[name="email"]')
      ...
      //Assert
      .get('input[type="checkbox"]:invalid')
      .should('have.length', 1);
  });
